 ...
 * @author unknown
 */
public class CreditCardApplicationUnitTest {
    ...
    public void createValidApplication() {
        ...
        CreditCardApplication testApp = new CreditCardApplication(BigInteger.valueOf(10000), "Express", borrowers);

        Set<ConstraintViolation<CreditCardApplication>> violations = validator.validate(testApp);
    ...
    public void createInvalidApplicationWithValidBorrower() {
        ...
        CreditCardApplication testApp = new CreditCardApplication(BigInteger.valueOf(1000000), "Express", borrowers);
        Set<ConstraintViolation<CreditCardApplication>> violations = validator.validate(testApp);
    ...
    @Test
    public void createInvalidApplicationWithNullCardType() {

        CreditCardApplication testApp = new CreditCardApplication(BigInteger.valueOf(10000), null, borrowers);
